...
<div class="heading">
   ...
   <p><a href="home.php">inicio</a> <span> / finalizar pedido</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="cart.php" class="btn">Olhar carrinho</a>
   </div>
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         ...
         <option value="pagamento na entrega (dinheiro)">Pagamento na Entrega (Dinheiro)</option>
         <option value="pagamento na entrega (cartão)">Pagamento na Entrega (Cartão)</option>
         <option value="pix">Pix</option>
         <option value="online">Pagamento Online</option>
      </select>
      <input type="submit" value="Fazer pedido" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--pink); color:var(--white);" name="submit">
   </div>
