...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      $message[] = 'e-mail ou número já cadastrado!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="celular" class="box" min="0" max="9999999999" maxlength="10">
      <input type="password" name="pass" required placeholder="crie uma senha" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
