...
if(isset($_POST['submit'])){
   ...
   if(!empty($number)){
      ...
      if($select_number->rowCount() > 0){
         $message[] = 'numero já está sendo usado!';
      }else{
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         $message[] = 'senhas não corresponde!';
      }else{
...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="insira sua antiga senha" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="insira sua nova senha" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
